...
//const POLKADOT_RUNTIME_FP string = "node_template_runtime.compact.wasm"
//const POLKADOT_RUNTIME_FP string = "node_template_runtime.wasm"
const POLKADOT_RUNTIME_FP string = "polkadot_runtime.compact_bu.wasm"
...
func TestCallCoreExecuteBlock(t *testing.T) {
	...
	// find heap_base
/*
	hb, err := r.vm.Exports["__heap_base"]
	if err != nil {
		t.Fatal(err)
	}
	t.Log("heap_base:", hb)
